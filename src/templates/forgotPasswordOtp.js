...
module.exports.forgotEmailOtpTemplate= function(code,name){
                        ...
                        <table style="border-spacing:0;" width="100%">
                          <tbody>
                            ...
                            <tr>
                              <td>
                                <center>
                                  <h2 class="description center" style="font-family:'Muli','Arial Narrow',Arial;Margin:0;text-align:center;max-width:320px;color:#a1a8ad;line-height:24px;font-size:15px;Margin-bottom:10px;margin-left: auto; margin-right: auto;"><span style="color: rgb(0, 0, 0); font-family: Muli, Arial, Narrow, Arial; font-size : 20px; text-align:center; background-color: rgb(240, 157, 151);">${code}</span></h2> 
                                </center>
                              </td>
                            </tr>
                          </tbody>
